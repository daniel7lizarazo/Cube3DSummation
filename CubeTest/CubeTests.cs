...
namespace CubeTest
{
    ...
    public class CubeTests
    {
        ...
        public void TheCubeUpdateCheckValue()
        {
            int size = 3;
            TheCube<CubeCoordinates> myCube = new(size);
            CubeOperations<CubeCoordinates> theOperator = new (myCube);

            CubeCoordinates testCoordinates = new CubeCoordinates(1,2,3,5);

            theOperator.UpdateACoordinateValue(testCoordinates);
        ...
        public void TheCubeQueryNoUpdate()
        {
            ...
            int queryResult = theOperator.QueryTheShape(initialQueryCoordinate, finalQueryCoordinate);
        ...
        public void TheCubeQueryWithUpdateCheckingIntoUpdateRange()
        {
            ...
            theOperator.UpdateACoordinateValue(updateCoordinate);
            int queryResult = theOperator.QueryTheShape(initialQueryCoordinate, finalQueryCoordinate);
        ...
        public void TheCubeQueryWithUpdateCheckingIntoUpdateRangeDisorganizedCoordinates()
        {
            ...
            theOperator.UpdateACoordinateValue(updateCoordinate);
            int queryResult = theOperator.QueryTheShape(finalQueryCoordinate, initialQueryCoordinate);
        ...
        public void ProposedExcerciseHackerRankTillQuery1()
        {
            ...
            theOperator.UpdateACoordinateValue(updateCoordinate);
            int res = theOperator.QueryTheShape(initialQueryCoordinate, finalQueryCoordinate);
        ...
        public void ProposedExcerciseHackerRankTillQuery2()
        {
            ...
            theOperator.UpdateACoordinateValue(updateCoordinate1);
            theOperator.UpdateACoordinateValue(updateCoordinate2);
            int res = theOperator.QueryTheShape(initialQueryCoordinate, finalQueryCoordinate);
        ...
        public void ProposedExcerciseHackerRankTillQuery4()
        {
            ...
            theOperator.UpdateACoordinateValue(updateCoordinate);
            int res = theOperator.QueryTheShape(initialQueryCoordinate, initialQueryCoordinate);
        ...
        public void ProposedExcerciseHackerRankTillQuery6()
        {
            ...
            theOperator.UpdateACoordinateValue(updateCoordinate);
            int res = theOperator.QueryTheShape(finalQueryCoordinate, finalQueryCoordinate);
